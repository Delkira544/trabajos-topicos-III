...
\paragraph{EXP 1 — Diseño principal (269 ejecuciones).}
...
porcentaje de soluciones factibles y calidad de solución. La combinación
\texttt{large} con \texttt{pop=16384} y variante \texttt{sequential} se omitió
por tiempo de ejecución excesivo.
...
\paragraph{EXP 3 — Análisis de \emph{speed-up} (269 ejecuciones).}
Para cada combinación instancia × población × semilla disponible en EXP 1
mide el tiempo de las tres variantes y calcula \emph{speed-up} = $T_{\text{seq}} / T_{\text{GPU}}$.
